...
# script logic start 
link=http://justgetflux.com/linux/xflux64.tgz
...
log "=== Soft linking xflux to /usr/bin (sudo password required).."
sudo ln -s xflux /usr/bin/xflux
