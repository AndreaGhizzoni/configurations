...
SHORT_PROGRAM_DESCRIPTION="Dropbox simple installer"
USAGE=""
USAGE_EXAMPLE=""
...
LINK="https://www.dropbox.com/download?dl=packages/ubuntu/dropbox_2019.02.14_amd64.deb"
...
wget -O dropbox.deb - "$LINK" || exit 1

log "=== INSTALLING DEB (root password required)..."
sudo dpkg -i dropbox.deb || exit 1
